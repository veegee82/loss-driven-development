...
# Define-Metric — cross-cutting, extends [Gradient Descent for Agents](./theory.md) to agent-defined objectives
...
See `./theory.md` §4 for the formal specification, `scripts/ldd_trace/test_metric_e2e.py` for 11 end-to-end scenarios, and `scripts/ldd_trace/test_metric_properties.py` for 23 hypothesis-proven algebraic laws.
